/* ============================================================
   ...
   Calendrier mensuel + créneaux + formulaire + localStorage
   ============================================================ */
(function () {
  "use strict";
  ...
  function renderSlots(key) {
    ...
    if (!slots.length) {
      el.slots.innerHTML = '<p style="grid-column:1/-1;color:var(--muted);font-style:italic;padding:10px">Aucun créneau ce jour-là.</p>';
      return;
    }
    var html = "";
